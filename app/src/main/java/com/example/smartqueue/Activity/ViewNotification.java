...
import com.example.smartqueue.Adapter.NotificationAdapter;
...
public class ViewNotification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue requestQueue= Volley.newRequestQueue(ViewNotification.this);
        String Url="http://smartq.fabstudioz.com/viewnotification.php";
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i=0;i<=jsonArray.length();i++)
                    {
                        ...
                        String notifi=jsonObject.optString("notification");
                        Notification notification=new Notification(notifi);
